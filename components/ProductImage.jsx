    ...
    return (
        <div className='hidden p-3 w-[50%] md:flex flex-col flex-1 left-[300px] relative items-center'>
            <div className='h-96 w-96 relative min-w-[300px]'>
                <Image src={detail.urls.regular} layout='fill' className='rounded-md' objectFit='cover' />
            </div>
            <div className='flex gap-1 p-2' >
                <div className='relative h-[200px] w-[200px]'>
                    <Image src={detail.urls.small} layout='fill' objectFit='cover' className='rounded-md' />
                </div>
                <div className='relative h-[200px] w-[200px]'>
                    <Image src={detail.urls.small} layout='fill' objectFit='cover' className='rounded-md' />
                </div>
            ...
            <div className='h-96 w-96 relative min-w-[300px] p-1'>
                <Image src={detail.urls.raw} layout='fill' className='rounded-md' objectFit='cover' />
            </div>
